      ...
      <div className="flex flex-1 flex-col gap-3 p-4">
        <div className="space-y-2">
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              <h3 className="line-clamp-3 font-display text-base font-bold uppercase leading-tight tracking-[0.08em] text-ink sm:text-lg xl:text-base">
                {product.name}
              </h3>
              {compact ? null : (
                <>
                  <p className="mt-2 line-clamp-2 text-sm leading-6 text-ink/65">{product.tagline}</p>
