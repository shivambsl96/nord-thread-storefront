export const collectionStories = [
  ...
  },
  {
    ...
    accentClass: "bg-coral",
    actionLabel: "Shop Growth"
  }
];

export const collectionStoryOrder = collectionStories.map((collection) => collection.handle);
